...
export const content = {
  ...
  app: {
    ...
    wizard: {
      ...
      venueSizeHelpers: {
        Small: '< 150 m² · biasanya s/d 150 tamu',
        Medium: '150–400 m² · biasanya 150–500 tamu',
        Large: '> 400 m² · biasanya 500+ tamu',
      },
      ...
      budgetHelpers: {
        Economy: 'Menentukan semewah apa tampilan desainnya · kisaran < Rp 50 jt',
        Standard: 'Menentukan semewah apa tampilan desainnya · kisaran Rp 50–150 jt',
        Premium: 'Menentukan semewah apa tampilan desainnya · kisaran Rp 150–400 jt',
        Luxury: 'Menentukan semewah apa tampilan desainnya · kisaran > Rp 400 jt',
      },
      paletteLabel: 'Palet warna (opsional)',
      paletteInvite: 'Atau pilih paletmu sendiri lewat color picker.',
      ...
      cancel: 'Batal',
      previewSwitchLabel: 'Tinjau prompt sebelum generate',
      previewSwitchHint: 'Nonaktif = desain langsung dibuat dari jawabanmu, tanpa layar pratinjau.',
    ...
    studio: {
      ...
      emptyBody: 'Tulis apa yang kamu inginkan di bawah untuk melihat konsep pertamamu.',
      emptyErrorTitle: 'Desain gagal dibuat',
      emptyErrorBody: 'Sepertinya ada kendala saat membuat desain. Coba lagi — prompt dan setupmu aman tersimpan.',
      emptyErrorCta: 'Coba buat ulang',
      design: 'Desain',
      generating: 'Membuat…',
      generatingElapsed: 'Membuat desain…',
      patience: 'Desain yang kompleks bisa butuh sampai beberapa menit.',
      generate: 'Buat Desain',
      composerPlaceholder: 'Tulis apa yang mau diubah…',
      analyze: 'Analisis',
      ...
      retry: 'Coba lagi',
      prompt: 'Prompt',
      tabInformasi: 'Informasi',
      tabHistory: 'Riwayat',
      tabFavorite: 'Favorit',
      favoritesSearchPlaceholder: 'Cari favorit…',
      favoritesEmptyTitle: 'Belum ada favorit',
      favoritesEmptyBody: 'Tandai desain dengan ikon bintang ★ di feed supaya gampang ditemukan di sini.',
      favoritesNoMatchTitle: 'Tidak ditemukan',
      favoritesNoMatchBody: 'Tidak ada favorit yang cocok dengan pencarianmu.',
      bookmarkDialogTitle: 'Simpan sebagai favorit',
      bookmarkRenameTitle: 'Ubah nama favorit',
      bookmarkNameLabel: 'Nama favorit',
      bookmarkNamePlaceholder: 'mis. Konsep utama, Opsi backup',
      bookmarkSave: 'Simpan',
      renameFavorite: 'Ubah nama favorit',
      favoriteSaved: 'Favorit tersimpan ✓',
      favoriteRenamed: 'Nama favorit diperbarui ✓',
      informasiDetailHeading: 'Detail',
      informasiAnalysisHeading: 'Analisis',
      ...
      modeGenerate: 'Buat gambar',
      modePlan: 'Rencana',
      modeGenerateHint: 'Kirim → langsung jadi gambar',
      modePlanHint: 'Ngobrol dulu buat matangkan ide, gratis',
      planPlaceholder: 'Tanya atau ceritakan idemu… (gratis, belum bikin gambar)',
      planThinking: 'Sedang menyusun…',
      planError: 'Balasan gagal dimuat.',
      planUseBrief: 'Pakai brief ini',
      planBriefLabel: 'Siap digambar',
      planSend: 'Kirim',
      planIntro: 'Mode rencana — ngobrol dulu buat matangkan konsep. Belum ada gambar dibuat sampai kamu pindah ke mode "Buat gambar".',
      // Design Workspace redesign (Version Explorer / Canvas / Inspector).
      original: 'Original',
      versionsHeading: 'Versi Desain',
      renameVersion: 'Ubah nama versi',
      renameVersionTitle: 'Ubah nama versi',
      versionRenamed: 'Nama versi diperbarui ✓',
      duplicateVersion: 'Duplikat versi',
      versionDuplicated: 'Versi diduplikasi ✓',
      deleteVersion: 'Hapus versi',
      deleteVersionConfirmTitle: 'Hapus versi ini?',
      deleteVersionConfirmBody: 'Versi dan checklist analisisnya akan dihapus permanen dari proyek ini.',
      deleteVersionCta: 'Ya, hapus',
      versionDeleted: 'Versi dihapus ✓',
      compareVersions: 'Bandingkan versi',
      navSummary: 'Ringkasan Proyek',
      ...
      zoomOut: 'Perkecil',
      zoomFit: 'Sesuaikan',
      toggleLabels: 'Tampilkan/sembunyikan label',
      ...
      applyEstimate: 'Terapkan estimasi',
      insightLoading: 'Menyusun saran…',
      insightError: 'Saran belum bisa dibuat. Coba lagi.',
      viewVendor: 'Lihat Vendor',
    ...
    analyze: {
      ...
      ctaSuggestBody: 'Lihat rincian tiap komponen dekorasi — panggung, kursi, bunga, pencahayaan — lengkap dengan estimasi biaya. Analisis desain ini untuk melihat detailnya.',
    ...
    compare: {
      ...
      barHint: 'Pilih 2 desain → lihat berdampingan, geser untuk membandingkan.',
      open: 'Bandingkan sekarang',
      clear: 'Batal',
      title: 'Bandingkan desain',
      hint: 'Geser garis di tengah gambar untuk membandingkan — tidak ada prompt yang dijalankan ulang.',
      before: 'Sebelum',
      after: 'Sesudah',
      diffTitle: 'Apa yang beda',
      noNote: 'Tanpa catatan tambahan — dibuat ulang dari prompt awal.',
      close: 'Tutup',
    },
    favorite: {
      add: 'Tandai favorit',
    ...
    share: {
      ...
      invalid: 'Link berbagi tidak valid atau sudah kedaluwarsa.',
    },
    vendors: {
